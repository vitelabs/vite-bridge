...
| wallet | sendTxByURI | {"uri":"[an string of vite uri schema]([https://vite.wiki/api/vitejs/utils/uri.html](http://localhost:8080/api/vitejs/utils/tools.html#stringify-an-transcation-info-to-an-vite-uri)) "} | the block generated|
